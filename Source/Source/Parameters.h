...
public:
	std::vector<std::unique_ptr<RangedAudioParameter>> getParameters() {
        ...
        parameters.push_back(std::make_unique<AudioParameterFloat>(INPUT_GAIN_ID, INPUT_GAIN_NAME, 0.f, 32.f, 1.f));
        parameters.push_back(std::make_unique<AudioParameterFloat>(SINAMOUNT_ID, SINAMOUNT_NAME, 0.0f, 100.0f, 0.0f));
        ...
        parameters.push_back(std::make_unique<AudioParameterBool>(PEAKBYPASS_ID, PEAKBYPASS_NAME, false));
        ...
        parameters.push_back(std::make_unique<AudioParameterFloat>(FILTERCHOICE_ID, FILTERCHOICE_NAME, 1.0f, 3.0f, 2.0f));
